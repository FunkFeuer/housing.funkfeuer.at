...
BLOG_TITLE = "FunkFeuer Housing"  # (translatable)
SITE_URL = "/"
BLOG_EMAIL = "admin@funkfeuer.at"
BLOG_DESCRIPTION = "Das FunkFeuer-Housing organisiert & betreibt ein nicht auf Gewinn ausgerichetetes, rein betriebskostendeckendes Server Housing."  # (translatable)
